...
//Lab 7 - Task 4 (Employee menu using dynamic allocation)
...
int i, selected = 0, index, employee_i[10]={0}, n;
struct Employee *pemps;
char key;
float minSalary;
...
pemps=(struct Employee*)malloc(n*sizeof(struct Employee));
